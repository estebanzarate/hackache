...
featured: true
image: ../../../../../images/writeups/hackthebox/cap/cap.png
difficulty: easy
platform: htb
os: linux
...
![Cap](@images/writeups/hackthebox/cap/cap.png)
...
![HTTP Service](@images/writeups/hackthebox/cap/http-service.webp)
...
![HTTP Data](@images/writeups/hackthebox/cap/http-data.webp)
