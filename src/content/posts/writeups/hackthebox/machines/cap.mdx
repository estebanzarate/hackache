...
tags:
  [hackthebox, linux, http, pcap, hardcoded-credentials, ftp, ssh, capabilities]
draft: false
lang: es
parent: writeups/hackthebox/machines
featured: true
image: ../../../../../images/writeups/hackthebox/machines/cap/cap.png
difficulty: easy
platform: htb
os: linux
...
![Cap](@images/writeups/hackthebox/machines/cap/cap.png)
...
![HTTP Service](@images/writeups/hackthebox/machines/cap/http-service.webp)
...
```bash
python3 pcaps.py -i 10.129.4.66
```
...
Probar las credenciales encontradas para acceder al servidor mediante el servicio FTP
...
Probar las credenciales encontradas para acceder al servidor mediante el servicio SSH
